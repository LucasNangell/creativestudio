...
export const homeDemos: HomeDemo[] = [
  {
    ...
    description:
      "Doações Pix e recorrentes, transparência, campanhas e área do doador para abrigos e ONGs.",
    category: "ONG / Terceiro Setor",
    stack: ["Next.js", "NestJS", "Prisma", "MySQL"],
    demoHref: "/demo/lar-dos-anjos",
    caseHref: "/cases/lar-dos-anjos",
  },
  {
    id: "gestao-producao-grafica",
    title: "Gestão de Produção Gráfica",
    description:
      "Ordens de serviço, kanban PCP, dashboards e análise técnica para operações gráficas.",
    category: "Gráfica / PCP",
    stack: ["React", "Vite", "FastAPI", "MySQL"],
    demoHref: "/demo/gestao-producao-grafica",
    caseHref: "/cases/gestao-producao-grafica",
  },
  {
    id: "player-video-marcadores",
    title: "Player de Vídeo Corporativo",
    description:
      "Biblioteca de vídeos com player avançado, marcadores navegáveis e busca inteligente.",
    category: "Mídia Interna",
    stack: ["Next.js", "Video.js", "FastAPI"],
    demoHref: "/demo/player-video-marcadores",
    caseHref: "/cases/player-video-marcadores",
  },
  {
    id: "vigilia-politica",
    title: "Vigília Política",
    description:
      "Central de inteligência com alertas, feed multicanal e briefings estratégicos simulados.",
    category: "GovTech",
    stack: ["React", "TypeScript", "Vite", "Tailwind CSS"],
    demoHref: "/demo/vigilia-politica",
    caseHref: "/cases/vigilia-politica",
  },
  {
    id: "site-psicologia-profissional",
    title: "Site para Psicóloga",
    description:
      "Site institucional com agendamento online, blog educativo e painel administrativo.",
    category: "Sites Institucionais",
    stack: ["PHP", "HTML5", "CSS3", "JavaScript"],
    demoHref: "/demo/site-psicologia-profissional",
    caseHref: "/cases/site-psicologia-profissional",
  },
  {
    id: "monitor-arquivos",
    title: "HT Monitor — Automação PDF",
    description:
      "Painel para monitorar pastas, renomear e mover arquivos PDF em fluxos de pré-impressão.",
    category: "Automação",
